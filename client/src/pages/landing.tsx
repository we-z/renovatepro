...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2 group cursor-pointer">
              ...
              <span className="text-2xl font-bold text-neutral-900 transition-colors duration-300 group-hover:text-primary">RenovatePro</span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-neutral-600 hover:text-primary transition-all duration-300 hover:scale-105 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">Features</a>
              <a href="#pricing" className="text-neutral-600 hover:text-primary transition-all duration-300 hover:scale-105 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">Pricing</a>
              <a href="#about" className="text-neutral-600 hover:text-primary transition-all duration-300 hover:scale-105 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full">How it Works</a>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/app">
                <Button variant="ghost" className="transition-all duration-300 hover:scale-105 hover:shadow-md">Sign In</Button>
              </Link>
              <Link href="/subscribe?plan=pro">
                <Button className="transition-all duration-300 hover:scale-105 hover:shadow-lg hover:-translate-y-1 bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary">Get Started</Button>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-tight">
                <span className="inline-block hover:scale-105 transition-transform duration-300">Connect with</span>
                <span className="text-primary bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent hover:from-blue-600 hover:to-primary transition-all duration-500"> Trusted Contractors</span>
                <br />
                <span className="inline-block hover:scale-105 transition-transform duration-300">for Your Next Project</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/subscribe?plan=pro">
                  <Button size="lg" className="w-full sm:w-auto group bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary transition-all duration-500 hover:scale-105 hover:shadow-xl hover:-translate-y-1 transform">
                    Start Your Project
                    <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                  </Button>
                </Link>
                <Link href="/app">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto group hover:bg-primary hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg border-2 hover:border-primary">
                    Try Demo
                  </Button>
                </Link>
              </div>
              <div className="flex flex-wrap items-center gap-6 mt-8 text-sm text-neutral-600">
                <div className="flex items-center group hover:scale-105 transition-transform duration-300">
                  ...
                  <span className="group-hover:text-green-600 transition-colors duration-300">Free to get started</span>
                </div>
                <div className="flex items-center group hover:scale-105 transition-transform duration-300">
                  <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 group-hover:scale-110 transition-transform duration-300" />
                  <span className="group-hover:text-green-600 transition-colors duration-300">No hidden fees</span>
                </div>
                <div className="flex items-center group hover:scale-105 transition-transform duration-300">
                  <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 group-hover:scale-110 transition-transform duration-300" />
                  <span className="group-hover:text-green-600 transition-colors duration-300">Cancel anytime</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative group">
                <div className="bg-white rounded-2xl shadow-2xl p-8 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 transform border border-neutral-100 hover:border-primary/20">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <div>
                      <h3 className="font-semibold group-hover:text-primary transition-colors duration-300">Kitchen Renovation</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <Button className="w-full group/btn bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary transition-all duration-300 hover:scale-105 hover:shadow-lg">
                      <span className="group-hover/btn:scale-105 transition-transform duration-300">Review Bids</span>
                    </Button>
                  </div>
                </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 bg-gradient-to-br from-neutral-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group hover:-translate-y-2 transition-all duration-500">
              ...
              <h3 className="text-2xl font-semibold text-neutral-900 mb-4 group-hover:text-primary transition-colors duration-300">Post Your Project</h3>
              <p className="text-neutral-600 leading-relaxed group-hover:text-neutral-700 transition-colors duration-300">
            ...
            <div className="text-center group hover:-translate-y-2 transition-all duration-500" style={{ animationDelay: '100ms' }}>
              <div className="w-20 h-20 bg-gradient-to-br from-primary to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg group-hover:shadow-2xl group-hover:shadow-primary/25">
                <span className="text-2xl font-bold text-white group-hover:scale-110 transition-transform duration-300">2</span>
              </div>
              <h3 className="text-2xl font-semibold text-neutral-900 mb-4 group-hover:text-primary transition-colors duration-300">Compare Proposals</h3>
              <p className="text-neutral-600 leading-relaxed group-hover:text-neutral-700 transition-colors duration-300">
            ...
            <div className="text-center group hover:-translate-y-2 transition-all duration-500" style={{ animationDelay: '200ms' }}>
              <div className="w-20 h-20 bg-gradient-to-br from-primary to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg group-hover:shadow-2xl group-hover:shadow-primary/25">
                <span className="text-2xl font-bold text-white group-hover:scale-110 transition-transform duration-300">3</span>
              </div>
              <h3 className="text-2xl font-semibold text-neutral-900 mb-4 group-hover:text-primary transition-colors duration-300">Manage & Communicate</h3>
              <p className="text-neutral-600 leading-relaxed group-hover:text-neutral-700 transition-colors duration-300">
              ...
              >
                <CardContent className="p-6 relative">
                  ...
                  <div className="group-hover:translate-x-1 transition-transform duration-300">
                    <p className="font-semibold text-neutral-900 group-hover:text-primary transition-colors duration-300">{testimonial.name}</p>
      ...
      <section id="pricing" className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
              ...
              >
                ...
                <CardHeader className="text-center pb-8 relative z-10">
                  ...
                  <div className="mb-4 group-hover:scale-105 transition-transform duration-300">
                    <span className="text-4xl font-bold text-neutral-900 group-hover:text-primary transition-colors duration-300">${plan.price}</span>
                    <span className="text-neutral-600">/{plan.period}</span>
                  </div>
                  <p className="text-neutral-600 group-hover:text-neutral-700 transition-colors duration-300">{plan.description}</p>
                </CardHeader>
                <CardContent className="pt-0 relative z-10">
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature, featureIndex) => (
                      ...
                      >
                        ...
                        <span className="text-neutral-700 group-hover/item:text-neutral-900 transition-colors duration-300">{feature}</span>
                      </li>
                    ))}
                  </ul>
                  <Link href={plan.name === "Enterprise" ? "/contact" : `/subscribe?plan=${plan.name.toLowerCase()}`}>
                    ...
                    >
                      <span className="group-hover/btn:scale-105 transition-transform duration-300">{plan.cta}</span>
                    </Button>
                  </Link>
                </CardContent>
              </Card>
          ...
          <div className="text-center mt-12 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            ...
            <Button variant="outline" size="lg" className="hover:bg-primary hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg">
              Contact Sales Team
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="animate-fade-in-up">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
              <span className="inline-block hover:scale-105 transition-transform duration-300">Ready to Start Your</span>
              <br />
              <span className="gradient-text bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text">Next Project?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/subscribe?plan=pro">
                <Button size="lg" variant="secondary" className="w-full sm:w-auto group bg-white text-primary hover:bg-blue-50 transition-all duration-300 hover:scale-105 hover:shadow-2xl transform">
                  <span className="group-hover:scale-105 transition-transform duration-300">Get Started Today</span>
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                </Button>
              </Link>
              <Link href="/app">
                <Button size="lg" variant="outline" className="w-full sm:w-auto text-white border-white hover:bg-white hover:text-primary transition-all duration-300 hover:scale-105 hover:shadow-2xl transform group">
                  <span className="group-hover:scale-105 transition-transform duration-300">Try Demo</span>
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2 group">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold group-hover:text-primary transition-colors duration-300">RenovatePro</span>
              </div>
              ...
              <div className="flex items-center space-x-4 group/secure hover:scale-105 transition-transform duration-300">
                ...
                <span className="text-sm text-neutral-400 group-hover/secure:text-green-300 transition-colors duration-300">Secure & Trusted Platform</span>
              </div>
            </div>
            <div className="group">
              <h3 className="font-semibold mb-4 group-hover:text-primary transition-colors duration-300">Platform</h3>
              <ul className="space-y-2 text-neutral-400">
                ...
                <li><a href="#about" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">How it Works</a></li>
                <li><a href="#" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Security</a></li>
              </ul>
            </div>
            <div className="group">
              <h3 className="font-semibold mb-4 group-hover:text-primary transition-colors duration-300">Support</h3>
              <ul className="space-y-2 text-neutral-400">
                <li><a href="#" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Help Center</a></li>
                <li><a href="#" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Contact Us</a></li>
                <li><a href="#" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Terms of Service</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-neutral-800 mt-12 pt-8 text-center text-neutral-400">
            <p className="hover:text-neutral-300 transition-colors duration-300">&copy; 2024 RenovatePro. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
